...
export function NoteList({ availableTags, notes, onUpdateTag, onDeleteTag }: NoteListProps) {
    ...
    return (
        <>
            ...
            <EditTagsModal onDeleteTag={onDeleteTag} onUpdateTag={onUpdateTag} show={editTagModalIsOpen} handleClose={() => setEditTagModalIsOpen(false)} availableTags={availableTags}/>
        </>
    )
}
